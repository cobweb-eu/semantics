...
public class Main {
	...
	private static void process(JsonElement data, Context context) throws FileNotFoundException {
	...
	private static void processFeature(JsonElement data, Context context) throws FileNotFoundException {
